...
import { createHolding } from '../../api/investments'
...
export default function AddHolding() {
  ...
  const handleSubmit = (e) => {
    ...
    createHolding(payload)
      ...
      .catch((err) => {
        const msgs = err.response?.data?.errors || ['Failed to add holding']
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-4 mb-8">
        <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">Add Holding</h1>
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <Button type="submit" disabled={loading} className="rounded-xl px-6 py-2.5">
